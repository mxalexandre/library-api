...
public class BookControllerTest {
    ...
    public void createBookTest() throws Exception {
        ...
        Book savedBook = Book.builder().id((long) 10).author("Artur").title("As aventuras").isbn("001").build();
    ...
    @Test
    @DisplayName("Deve lançar um erro quando não houver dados suficientes para criar o livro.")
    ...
    @Test
    @DisplayName("Erro ao tentar cadastrar livro com isbn já utilizado por outro livro.")
    ...
    @Test
    @DisplayName("Deve retornar resource not found quando o livro não procurado não existir.")
    ...
    public void updateBookTest() throws Exception {
        ...
        Book updatingBook = Book.builder().id(id).author("some title").title("some author").isbn("321").build();
